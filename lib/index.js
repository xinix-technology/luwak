...
function luwak(url, parentO) {
  'use strict';

  var luwakO = function LuwakO(url) {
    return luwak(url, luwakO);
  };
  ...
  Object.setPrototypeOf(luwakO, luwak);

  return luwakO;
}


luwak.prepare = function(name, filter) {
  'use strict';
  this.filters[name] = filter;
  return this;
};

luwak.use = function(middleware) {
  'use strict';
  this.middlewares.push(middleware);
  return this;
};

luwak.select = function(selector) {
  'use strict';
  this.selector = selector;
  return this;
};

luwak.query = function(selector, $, isArray) {
  'use strict';
